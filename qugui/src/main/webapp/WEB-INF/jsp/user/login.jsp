...
<div class="QuGuiFullScreenContainer">
    ...
    <div class="bottomBox">
        <div class="loginBox">
            <form class="loginBox" method="post" action="/user/loginResult">
                <input name="userName" placeholder="用户名/邮箱/手机号" type="text" class="QuGuiTextInput QuGuiSizeLarge QuGuiMarginTop30" />
                <input name="password" placeholder="密码" type="password" class="QuGuiTextInput QuGuiMarginTop10 QuGuiSizeLarge" />
